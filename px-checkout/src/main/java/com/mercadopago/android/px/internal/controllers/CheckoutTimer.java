...
import com.mercadopago.android.px.internal.callbacks.TimerObserver;
...
public class CheckoutTimer implements Timer {
    ...
    public static synchronized CheckoutTimer getInstance() {
        if (mCountDownTimerInstance == null) {
            mCountDownTimerInstance = new com.mercadopago.android.px.internal.controllers.CheckoutTimer();
        }
    ...
    public void setOnFinishListener(
        com.mercadopago.android.px.internal.controllers.CheckoutTimer.FinishListener finishListener) {
