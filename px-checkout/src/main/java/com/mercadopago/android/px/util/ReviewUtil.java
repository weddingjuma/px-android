...
public class ReviewUtil {
    ...
    public static int getPaymentInstructionTemplate(PaymentMethod paymentMethod) {
        ...
        if (key.startsWith("pagofacil")) {
            resource = R.string.px_review_off_text;
            ...
            resource = R.string.px_review_off_text_4;
            ...
            resource = R.string.px_review_off_text_6;
        } else if (key.startsWith("webpay")) {
            resource = R.string.px_review_off_text_5;
            ...
            resource = R.string.px_review_off_text_default;
        }
        return resource;
    }
    ...
    public static String getPaymentMethodDescription(PaymentMethod paymentMethod, String description, Context context) {
        ...
        case "rapipago":
            ...
            break;
        case "redlink_atm":
            string = context.getResources().getString(R.string.px_your_atm) + " " + paymentMethod.getName();
            break;
        case "redlink_bank_transfer":
            string = context.getResources().getString(R.string.px_homebanking) + " " + paymentMethod.getName();
            break;
