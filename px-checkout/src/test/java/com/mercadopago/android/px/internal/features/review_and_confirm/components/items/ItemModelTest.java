...
public class ItemModelTest {
    ...
    public void whenQuantityIsUniqueThenHideIt() {
        ItemModel model =
            new ItemModel(ITEM_IMAGE_URL, ITEM_TITLE, ITEM_SUBTITLE, 1, ITEM_CURRENCY_ID, ITEM_UNIT_PRICE);
    ...
    public void whenQuantityIsMultipleThenShowIt() {
        ItemModel model =
            new ItemModel(ITEM_IMAGE_URL, ITEM_TITLE, ITEM_SUBTITLE, 3, ITEM_CURRENCY_ID, ITEM_UNIT_PRICE);
