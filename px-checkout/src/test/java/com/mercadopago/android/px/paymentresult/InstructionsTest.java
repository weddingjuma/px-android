...
public class InstructionsTest {
    ...
    public void testInstructionHasSubtitle() {
        ...
        final com.mercadopago.android.px.paymentresult.components.Instructions component =
    ...
    public void testOnGatewayThenDontShowEmailInSecondaryInfo() {
        ...
        final com.mercadopago.android.px.paymentresult.components.Instructions component =
            new com.mercadopago.android.px.paymentresult.components.Instructions(props, dispatcher);

        Assert.assertFalse(component.shouldShowEmailInSecondaryInfo());
    }

    private com.mercadopago.android.px.paymentresult.components.Instructions getInstructionsComponent(
