...
public class CheckoutPresenterTest {
    ...
    public void whenDefaultCardIdIsNullAndDefaultPaymentTypeIsValidThenShowNewCardFlow(){
        final CheckoutPresenter presenter = getBasePresenter(PAYMENT_RESULT_CODE,view,provider);
        PaymentMethodSearch search = mockPaymentMethodSearchForNewCardDriver();
        presenter.startFlow(search);
    ...
    private PaymentMethodSearch mockPaymentMethodSearchForNewCardDriver(){
        ...
        when(configuration.getCheckoutPreference().getPaymentPreference().getDefaultPaymentTypeId()).thenReturn("debit_card");
        return search;
    }
    ...
    private PaymentMethodSearch mockPaymentMethodSearchForDriver(boolean isValidCard) {
        ...
        when(configuration.getCheckoutPreference().getPaymentPreference().getDefaultPaymentMethodId()).thenReturn("debcabal");
        return search;
    }
